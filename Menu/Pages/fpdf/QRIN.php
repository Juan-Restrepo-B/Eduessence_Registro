...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $consulta_info = $conn->query("SELECT * FROM ENTRADA_SALIDA WHERE IDPUNTO = $idPunto"); //traemos datos de la empresa desde BD WHERE IDPUNTO='$idpun'
      $dato_info = $consulta_info->fetch_object();
      $this->Image('../qr_codes/entrada-salida/' . $dato_info->INOUT_QR, 4, 45, 200); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
