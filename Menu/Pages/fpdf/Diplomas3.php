...
class PDF extends FPDF
{
   ...
   function Header()
   {
      $this->Image('DIPLOMAS3.png', 0, 0, 297); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
...
$pdf->Output('Prueba7-1.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
